<template>
  <modal name="modal-add-item" @before-open="beforeOpen">
    <div>
      <h6 class="mx-3 mt-3 small font-weight-bold">Add new task</h6>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-8 text-right">
              ...
              <div v-if="response == 'Empty string'">
                <div class="text-danger">You need to provide the name</div>
              </div>
...
export default {
  ...
  methods: {
    ...
    saveTodoItem() {
      ...
      TodoItemDataService.create(data)
        .then((response) => {
